...
import { previewKind, useAttachmentPreview } from '../../composables/use-attachment-preview'
...
const { filePreview, docxPreviewEl, closeFilePreview, openFilePreview } = useAttachmentPreview()
